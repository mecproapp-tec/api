    ...
    win.document.write(`
      <html>
        ...
        <body>
          ...
          <p><strong>Documento:</strong> ${cliente?.document || "Não informado"}</p>
          <p><strong>Endereço:</strong> ${cliente?.address || "Não informado"}</p>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.infoGrid}>
            ...
            <div>
              ...
              <span style={styles.value}>{cliente.address || "Não informado"}</span>
            </div>
          </div>
